...
public class Numbers {
    ...
    public void findsOddNumbersOver10() {
        List<Integer> oddNumbersOver10 = numbers.stream().filter(x -> x % 2 == 1 && x > 10).toList();
    ...
    public void findsSquaredOddNumbers() {
        List<Integer> squaredOddNumbers = numbers.stream().filter(x -> x % 2 == 1).map(x -> x * x).toList();
    ...
    public void findsSumOfOddNumbers() {
        Integer result = numbers.stream().filter(x -> x % 2 == 1).mapToInt(x -> x).sum();
